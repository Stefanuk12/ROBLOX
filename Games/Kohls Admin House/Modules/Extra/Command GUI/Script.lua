...
intall.Size = UDim2.new(0, 300, 0, 50)
...
intmusic.Size = UDim2.new(0, 300, 0, 50)
...
intgeargiver.Size = UDim2.new(0, 300, 0, 50)
intgeargiver.AutoButtonColor = false
intgeargiver.Font = Enum.Font.Gotham
intgeargiver.Text = "    > :intgeargiver - starts gear giver module"
...
intserveroof.Size = UDim2.new(0, 300, 0, 50)
intserveroof.AutoButtonColor = false
intserveroof.Font = Enum.Font.Gotham
intserveroof.Text = "    > :intserveroof - starts server oof module"
...
intsoundabuse.Size = UDim2.new(0, 300, 0, 50)
intsoundabuse.AutoButtonColor = false
intsoundabuse.Font = Enum.Font.Gotham
intsoundabuse.Text = "    > :intsoundabuse - starts sound abuse module"
...
intanti.Size = UDim2.new(0, 300, 0, 50)
...
regen.Size = UDim2.new(0, 300, 0, 50)
...
getadmin.Size = UDim2.new(0, 300, 0, 50)
...
tpadmin.Size = UDim2.new(0, 300, 0, 50)
...
antipunish.Size = UDim2.new(0, 300, 0, 50)
...
antikill.Size = UDim2.new(0, 300, 0, 50)
...
antiblind.Size = UDim2.new(0, 300, 0, 50)
...
movebaseplate.Size = UDim2.new(0, 300, 0, 50)
...
partspam.Size = UDim2.new(0, 300, 0, 50)
...
respam.Size = UDim2.new(0, 300, 0, 50)
...
pallsounds.Size = UDim2.new(0, 300, 0, 50)
...
sallsounds.Size = UDim2.new(0, 300, 0, 50)
...
pmusic.Size = UDim2.new(0, 300, 0, 50)
...
smusic.Size = UDim2.new(0, 300, 0, 50)
...
earrape.Size = UDim2.new(0, 300, 0, 50)
